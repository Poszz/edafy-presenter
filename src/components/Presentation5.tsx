...
import { TitleSlide } from './slides5/TitleSlide';
import { VideoSlide } from './slides5/VideoSlide';
import { AboutSlide } from './slides5/AboutSlide';
import { ChallengeSlide } from './slides5/ChallengeSlide';
import { SolutionsSlide } from './slides5/SolutionsSlide';
import { ValueSlide } from './slides5/ValueSlide';
import { DemoSlide } from './slides5/DemoSlide';
...
interface Presentation5Props {
  onBack: () => void;
}

export function Presentation5({ onBack }: Presentation5Props) {
